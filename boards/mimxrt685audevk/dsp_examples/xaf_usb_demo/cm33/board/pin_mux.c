...
- pin_list:
  ...
  - {pin_num: D6, peripheral: FLEXCOMM2, signal: RXD_SDA_MOSI_DATA, pin_signal: PIO0_16/FC2_RXD_SDA_MOSI_DATA/SCT0_GPI2/SCT0_OUT2/CTIMER2_MAT2/I2S_BRIDGE_DATA_IN/SEC_PIO0_16,
    pupdena: enabled, pupdsel: pullUp, ibena: enabled, slew_rate: normal, amena: disabled, odena: enabled, iiena: disabled}
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t LED0853_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO2_15 (pin E2)  */
    GPIO_PinInit(BOARD_INITPINS_LED0853_GPIO, BOARD_INITPINS_LED0853_PORT, BOARD_INITPINS_LED0853_PIN, &LED0853_config);
    ...
    const uint32_t LED0853 = (/* Pin is configured as PIO2_15 */
                              IOPCTL_PIO_FUNC0 |
                              /* Disable pull-up / pull-down function */
                              IOPCTL_PIO_PUPD_DI |
                              /* Enable pull-down function */
    ...
    IOPCTL_PinMuxSet(IOPCTL, BOARD_INITPINS_LED0853_PORT, BOARD_INITPINS_LED0853_PIN, LED0853);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
