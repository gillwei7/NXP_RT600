...
//    	MEMPOOL_BUF = malloc(BUF_SIZE);
		...
		FlowEngine_query_cmd(engine, "init/16/");
		...
		FlowEngine_query_cmd(engine, "obj/OUT/OUT_2/8/-1/-1/-1/0/");
		FlowEngine_query_cmd(engine, "obj/OUT/OUT_3/11/-1/-1/-1/0/");
		FlowEngine_query_cmd(engine, "obj/OUT/OUT_4/10/-1/-1/-1/0/");
		FlowEngine_query_cmd(engine, "obj/OUT/OUT_5/13/-1/-1/-1/0/");
		FlowEngine_query_cmd(engine, "obj/OUT/OUT_6/12/-1/-1/-1/0/");
		FlowEngine_query_cmd(engine, "obj/OUT/OUT_7/15/-1/-1/-1/0/");
		FlowEngine_query_cmd(engine, "obj/OUT/OUT_8/14/-1/-1/-1/0/");
		FlowEngine_query_cmd(engine, "reprepare/");
		FlowEngine_query_cmd(engine, "buildProcStep/");
		FlowEngine_query_cmd(engine, "wire/IN_1@0/OUT_2@0/");
		FlowEngine_query_cmd(engine, "wire/IN_2@0/OUT_1@0/");
		FlowEngine_query_cmd(engine, "wire/IN_3@0/OUT_4@0/");
		FlowEngine_query_cmd(engine, "wire/IN_4@0/OUT_3@0/");
		FlowEngine_query_cmd(engine, "wire/IN_5@0/OUT_6@0/");
		FlowEngine_query_cmd(engine, "wire/IN_6@0/OUT_5@0/");
		FlowEngine_query_cmd(engine, "wire/IN_7@0/OUT_8@0/");
		FlowEngine_query_cmd(engine, "wire/IN_8@0/OUT_7@0/");
